...
test('Maybe concat properties (Semigroup)', t => {
  ...
  t.ok(concat.associativity(equals, ra, rb, rc), 'Just associativity')
  t.ok(concat.associativity(equals, la, lb, lc), 'Nothing associativity')
...
test('Maybe map properties (Functor)', t => {
  ...
  t.ok(map.identity(equals, Maybe.Just(null)), 'Just identity')
  t.ok(map.composition(equals, f, g, Maybe.Just(10)), 'Just composition')

  t.ok(map.identity(equals, Maybe.Nothing()), 'Nothing identity')
  t.ok(map.composition(equals, f, g, Maybe.Nothing()), 'Nothing composition')
...
test('Maybe ap properties (Apply)', t => {
  ...
  t.ok(ap.composition(equals, rg, rf, rv), 'Just composition')
  t.ok(ap.composition(equals, lg, lf, lv), 'Nothing composition')
...
test('Maybe chain properties (Chain)', t => {
  ...
  t.ok(chain.associativity(equals, rf, rg, rv), 'Just associativity')
  t.ok(chain.associativity(equals, lf, lg, lv), 'Nothing associativity')
